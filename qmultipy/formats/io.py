...
from qmultipy.mpi import SerialComm, MP
...
IOFormats= {
            "snpy"   : ioformat('snpy'  ,'qmultipy.formats.snpy'  ,'read_snpy'  ,'write_snpy'  ,['ions','data','all']),
            "xsf"    : ioformat('xsf'   ,'qmultipy.formats.xsf'   ,'read_xsf'   ,'write_xsf'   ,['ions','data','all']),
            "qepp"   : ioformat('qepp'  ,'qmultipy.formats.qepp'  ,'read_qepp'  ,'write_qepp'  ,['ions','data','all']),
            "cube"   : ioformat('cube'  ,'dqmultipy.formats.cube'  ,'read_cube'  ,'write_cube'  ,['ions','data','all']),
            "chg"    : ioformat('chg'   ,'qmultipy.formats.chg'   ,'read_chg'   ,'write_chg'   ,['ions','data','all']),
            "chgcar" : ioformat('chgcar','qmultipy.formats.chg'   ,'read_chgcar','write_chgcar',['ions','data','all']),
            ...
            "vasp"   : ioformat('vasp'  ,'qmultipy.formats.vasp'  ,'read_vasp'  ,'write_vasp'  ,['ions']),
            "ase"    : ioformat('ase'   ,'qmultipy.formats.ase_io','read_ase'   ,'write_ase'   ,['ions']),
            "pmg"    : ioformat('pmg'   ,'qmultipy.formats.pmg_io','read_pmg'   ,'write_pmg'   ,['ions']),
        }
