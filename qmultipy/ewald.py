...
from qmultipy.field import DirectField, ReciprocalField
...
class CBspline(object):
    ...
    def Barray(self):
        if self._Barray is None:
            ...
            self._Barray = ReciprocalField(self.grid.get_reciprocal(), data=array, rank=1)
        return self._Barray
    ...
    def _calc_PME_Qarray(self, ions = None):
        ...
        return DirectField(self.grid, data=Qarray, rank=1)
...
class Ewald(object):
    ...
    def compute(self, *args, calcType = {'E'}, **kwargs):
        ...
        from qmultipy.functional.functional_output import FunctionalOutput
...
ewald = Ewald # backward compatibility
